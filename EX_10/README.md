\# EX\_10 — Azure Cognitive Services Labs
...
> Full instructions are in `EX\_10\_Instructions\_1.pdf` and `EX\_10\_Instructions\_2.pdf`.
...
`EX\_10\_Instructions\_1.pdf` covers Azure Cognitive Services Lab 1.
...
`EX\_10\_Instructions\_2.pdf` covers Azure Cognitive Services Lab 2.
...
./analyze-image-internet.ps1 -img "IMAGE\_URL\_HERE"
...
https://e-racuni.com/Croatian/wiki-images/invoice\_COMPLEX.jpg
...
$predictionUrl="YOUR\_PREDICTION\_URL"

$predictionKey="YOUR\_PREDICTION\_KEY"
...
computervision\_client = ComputerVisionClient(endpoint, CognitiveServicesCredentials(key))
...
!wget https://farm4.staticflickr.com/3789/10177514664\_0ff9a53cf8\_z.jpg -O note.jpg
...
$key="YOUR\_LANGUAGE\_KEY"

$endpoint="YOUR\_LANGUAGE\_ENDPOINT"
...
setx SPEECH\_KEY "your-key"

setx SPEECH\_REGION "your-region"
...
curl --location --request POST "https://$env:SPEECH\_REGION.stt.speech.microsoft.com/speech/recognition/conversation/cognitiveservices/v1?language=en-US\&format=detailed" --header "Ocp-Apim-Subscription-Key: $env:SPEECH\_KEY" --header "Content-Type: audio/wav" --data-binary "@YourAudioFile.wav"
...
Exercise\_10\_Azure\_Cognitive\_Services\_YourName.pdf
...
\- `EX\_10\_Instructions\_1.pdf`

\- `EX\_10\_Instructions\_2.pdf`
